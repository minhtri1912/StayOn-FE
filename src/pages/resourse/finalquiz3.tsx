...
export default function FinalQuiz3() {
  return (
    <div className="min-h-screen bg-white py-12 px-4 relative">
      <main className="max-w-4xl mx-auto text-center">
  {/* decorative image on larger screens */}
        <div className="flex justify-center mb-6">
          <img src={miniQuiz3} alt="Mini Quiz #1" className="w-full max-w-[500px] h-auto object-contain" />
        </div>
        ...
        <div className="mt-12 flex items-center justify-center gap-6">
          <Link to="/resources/" className="inline-block bg-indigo-400 text-white px-8 py-3 rounded-full shadow-md hover:bg-indigo-500">Tài Nguyên</Link>
