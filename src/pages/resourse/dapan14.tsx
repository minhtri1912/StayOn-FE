...
export default function Dapan14() {
      ...
      <main className="min-h-screen bg-white py-12 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <section className="bg-white">
            ...
            <div className="mt-6">
              <p className="text-base mb-4 text-center">4. Đâu là yếu tố có thể làm tăng nguy cơ mắc ADHD?</p>
              ...
              <div className="space-y-4">
                ...
                {(() => {
                  ...
                  return [
                    { key: 'A', text: 'Sinh non' },
                    { key: 'B', text: 'Ăn nhiều đường' },
                    { key: 'C', text: 'Chơi điện tử quá nhiều' },
                    { key: 'D', text: 'Đọc sách quá ít' }
                  ].map((opt) => {
              ...
              <div className="mt-6 flex flex-col md:flex-row gap-4">
                <Link to="/resources/quiz15" className="flex-1 inline-block px-8 py-3 rounded-full bg-[#34D399] text-black font-bold text-center">Tiếp tục</Link>
                <Link to="/resources/quiz14" className="flex-1 inline-block px-8 py-3 rounded-full bg-black text-white font-bold text-center">Làm lại</Link>
              </div>
            </div>
          </section>
          ...
          <aside className="bg-white mt-8 md:mt-16">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 mb-4">Sinh non là một trong các yếu tố nguy cơ liên quan đến ADHD. Các yếu tố khác bao gồm tiếp xúc với độc tố, mẹ sử dụng rượu, thuốc lá trong thai kỳ</p>
