...
export default function FinalQuiz() {
  ...
  {/* decorative image on larger screens */}
        <div className="flex justify-center mb-6">
          <img src={quizTest} alt="Mini Test #1" className="w-full max-w-[500px] h-auto object-contain" />
        </div>
        ...
        <div className="mt-12 flex items-center justify-center gap-6">
          <Link to="/resources/quiz2" className="inline-block bg-indigo-400 text-white px-8 py-3 rounded-full shadow-md hover:bg-indigo-500">Bắt đầu Test 2</Link>
