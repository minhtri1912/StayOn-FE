...
export default function Dapan32() {
      ...
      <main className="min-h-screen bg-white py-12 px-4">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          ...
          <section className="bg-white">
            ...
            <div className="mt-6">
              <p className="text-base mb-4 text-center">2. Đặc điểm nào sau đây thường thấy ở người mắc ADHD khi giao tiếp?</p>
              ...
              <div className="space-y-4">
                {(() => {
                  ...
                  return [
                    { key: 'A', text: 'Ít khi ngắt lời người khác' },
                    { key: 'B', text: 'Nói chuyện trôi chảy, không bị ngắt quãng' },
                    { key: 'C', text: 'Dễ ngắt lời hoặc nói trước khi người khác kết thúc' },
                    { key: 'D', text: 'Luôn lắng nghe chăm chú' }
                  ].map((opt) => {
              ...
              <div className="mt-6 flex flex-col md:flex-row gap-4">
                <Link to="/resources/quiz33" className="flex-1 inline-block px-8 py-3 rounded-full bg-[#34D399] text-black font-bold text-center">Tiếp tục</Link>
                <Link to="/resources/quiz32" className="flex-1 inline-block px-8 py-3 rounded-full bg-black text-white font-bold text-center">Làm lại</Link>
              </div>
            </div>
          </section>
          ...
          <aside className="bg-white mt-8 md:mt-16">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-700 mb-4">Người mắc ADHD thường có xu hướng ngắt lời hoặc nói trước khi người khác kết thúc do tính bốc đồng (impulsivity)</p>
